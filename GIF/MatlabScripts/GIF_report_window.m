classdef GIF_report_window < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function startupFcn(app, mesh)
            ...
            app.eaLabel.Text = num2str(mesh.parametersMatrix(9,1));
            app.ea99Label.Text = num2str(mesh.parametersMatrix(10,1));
            app.keLabel.Text = num2str(mesh.parametersMatrix(11,1));
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 1184 759];
            ...
            app.MeshStatisticsPanel.Position = [94 396 431 233];
            ...
            app.verticesLabel = uilabel(app.MeshStatisticsPanel);
            app.verticesLabel.FontSize = 19;
            app.verticesLabel.Position = [293 158 124 23];
            app.verticesLabel.Text = 'vertices';

            % Create trianglesLabel
            app.trianglesLabel = uilabel(app.MeshStatisticsPanel);
            app.trianglesLabel.FontSize = 19;
            app.trianglesLabel.Position = [293 119 77 23];
            app.trianglesLabel.Text = 'triangles';
            ...
            app.meta_verticesLabel.Position = [293 32 124 23];
            ...
            app.ResultInformationPanel.Position = [637 17 475 612];
            ...
            app.totaltimeLabel.Position = [375 537 77 23];
            ...
            app.keLabel.Position = [376 284 88 23];
            app.keLabel.Text = 'ke';
            ...
            app.ffLabel.Position = [376 149 63 23];
            app.ffLabel.Text = 'ff';
            ...
            app.sctLabel.Position = [376 251 88 23];
            ...
            app.VisualizeMeshinMatlabButton.Position = [94 318 264 53];
            ...
            app.ExportResulttoobjFileButton.Position = [94 166 264 53];
            ...
            app.VisualizeUVLayoutinMatlabButton.Position = [94 240 264 53];
            ...
            app.ExportResulttomatFileButton.Position = [94 93 264 53];
            ...
            app.SaveMeshStatisticsandResultInformationButton.Position = [94 17 264 53];
